...
import { FixturaTimeline } from "@/components/containers/Timeline";
import { DeveloperComment } from "@/components/PageSelectedRender/client/DeveloperComment";
import { H } from "@/components/Type/Headers";
import { P } from "@/components/Type/Paragraph";
import { BUTTON_FUNC, BUTTON_LINK } from "@/components/UI/buttons";
...
export async function BundleUpdates({ id }) {
  return (
    <FixturaContainer my={30} mx={"0%"}>
      <FixturaGroup position="right" my={20}>
        <BUTTON_LINK Label={"Back"} href={`/${id}`} />
      </FixturaGroup>
      <FixturaTimeline>
